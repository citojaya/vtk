...
# parse command line:
p = OptionParser(usage="""Program <angVel> <end>

Read capsule mesh and genrate separate files for rotation 
<infile> - capsule-wall.dat (capsule mesh file)
<angVel> angular velocity in rad/s
<end> - number of steps to be generated
...
for n in range (int(steps)):
    ...
    for i in range(len(nodes)):
        ...
        # newY = xx*np.sin(omega*(n))+yy*np.cos(omega*(n)) 
        # newZ = zz    
